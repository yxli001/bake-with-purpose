        ...
        <Padding style={{ backgroundColor: "#ff96d6" }}>
            <div className={styles.container}>
                ...
                <ul className={styles.qualifications}>
                    ...
                    <li className={styles.qualification}>
                        Members should be responsible, reliable, and willing to
                        devote their time to supporting the community
                    </li>
                    <li className={styles.qualification}>
                        Members must be at least 6th grade in the school year of
                        application
                    </li>
                    <li className={styles.qualification}>
                        Rights: Participation in events where members are able
                        to improve baking and other skills and help out the
